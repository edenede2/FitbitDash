...
def main(project, now, username):
    ...
    #     print(e)
    #     logging.error(e)
    #     logging.info(f'File generation failed')
    #     time.sleep(10)
...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename=fr'.\logs\EDA_{now}.log', level=logging.INFO)
    logging.info(f'EDA started at {now} by {user_name}')
