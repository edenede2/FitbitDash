...
def main(project, now, username):
    try:
        ...
        logging.info(f'Failed to generate the final')
        time.sleep(10)
...
if __name__ == '__main__':
    ...
    logging.basicConfig(filename=fr'.\logs\Final_{now}.log', level=logging.INFO)
    logging.info(f'Final script started at {now}')
