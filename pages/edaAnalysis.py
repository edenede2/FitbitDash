        ...
        dbc.Row([
            ...
            dbc.Row([
                ...
                dbc.Row([
                    ...
                    dbc.Col([
                        html.Div(id='outputs-dropdowns-EDA'),
                    ])
                ])
            ]),
            html.Div([
                html.Hr(),
                html.Div(id='outputs-plots-EDA'),
...
@callback(
    Output('output-file-path-EDA', 'data'),
    Output('outputs-dropdowns-EDA', 'children'),
...
def show_file(n_clicks, selected_rows, selected_folder, project):
    ...
    column_selection_dropdown = dcc.Dropdown(
        id={
            'type': 'column-selection-dropdown-EDA',
            'index': 1
        },
...
@callback(
    Output('outputs-plots-EDA', 'children'),
    Output({'type': 'file-content-EDA', 'index': ALL}, 'children'),
    Input({'type': 'load-content-button-EDA', 'index': ALL}, 'n_clicks'),
    State({'type': 'select-id-Dropdown-EDA', 'index': ALL}, 'value'),
    State({'type': 'column-selection-dropdown-EDA', 'index': ALL}, 'value'),
    State('output-file-path-EDA', 'data'),
    State({'type': 'select-id-Dropdown-EDA', 'index': ALL}, 'disabled')
)
